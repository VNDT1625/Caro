...
export default function GameBoard({
  ...
  return (
    <div style={{
      ...
      {/* Compact mode: remove side status chips above the board */}

      {/* Removed winner banner to avoid duplicate status cards */}

      {(() => {
        const cell = Math.max(20, Math.min(64, Math.round(cellSizePx)))
      ...
      {/* Removed bottom counters, reset button, and forbidden badge per compact layout */}
